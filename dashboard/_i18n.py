...
RW = {
    ...
    'AgriRisk pilot': 'Igerageza rya AgriRisk',
    'strongly disagree to strongly agree': 'simbyemera na gato kugeza ku kubyemera cyane',
    'You are a': 'Uri',
    'Extension officer': "Umujyanama w'ubuhinzi",
    'Farmer': 'Umuhinzi',
    'Participant code': "Kode y'uwitabiriye",
    'Which part are you rating?': 'Ni iyihe nzego urimo gusuzuma?',
    'Perceived usefulness': 'Akamaro kagaragara',
    'Perceived ease of use': 'Uburyo byoroshye gukoresha',
    'Satisfaction': 'Kunyurwa',
    'Confidence': 'Icyizere',
    'Confidence in data-driven advisories': 'Icyizere mu nama zishingiye ku makuru',
    'Usefulness': 'Akamaro',
    'Ease of use': 'Kworoha gukoresha',
    'Anything else? (optional)': 'Hari ikindi? (ntibisabwa)',
    'Your comments…': 'Ibitekerezo byawe…',
    'Submit feedback': 'Ohereza igitekerezo',
    'Strongly disagree': 'Simbyemera na gato',
    'Disagree': 'Simbyemera',
    'Neutral': 'Hagati',
    'Agree': 'Ndabyemera',
    'Strongly agree': 'Ndabyemera cyane',
    'Please enter your participant code (for example EO-01).': "Andika kode yawe y'uwitabiriye (urugero EO-01).",
    'Could not save your response. Please try again.': 'Ntibyashobotse kubika igisubizo cyawe. Ongera ugerageze.',
    'Thank you! Your response was recorded anonymously.': 'Murakoze! Igisubizo cyawe cyanditswe nta izina ryawe.',
    'What you told us': 'Ibyo watubwiye',
    'Recorded': 'Byanditswe',
    'Privacy': 'Ibanga',
    'Anonymous. No names or phone numbers are stored.': 'Nta izina. Nta mazina cyangwa nimero za telefoni bibikwa.',
    'Purpose': 'Intego',
    'Academic evaluation of the AgriRisk pilot.': "Isuzuma ry'ubushakashatsi ku igerageza rya AgriRisk.",

    # --- 12-item TAM instrument (RQ4) ---
    'Using AgriRisk improves the farming decisions I make.': "Gukoresha AgriRisk bunoza ibyemezo by'ubuhinzi mfata.",
    'Using AgriRisk saves me time when I need crop or market information.': "Gukoresha AgriRisk binzigamira igihe iyo nkeneye amakuru y'imyaka cyangwa ay'isoko.",
    'Using AgriRisk makes it easier to plan the season.': 'Gukoresha AgriRisk byorohereza gutegura igihembwe.',
    'Overall, I find AgriRisk useful in my work.': 'Muri rusange, mbona AgriRisk ifite akamaro mu kazi kanjye.',
    'Learning to use AgriRisk was easy for me.': 'Kwiga gukoresha AgriRisk byari byoroshye kuri njye.',
    'I can get AgriRisk to show me what I want without difficulty.': 'Nshobora gutuma AgriRisk inyereka icyo nshaka nta ngorane.',
    'The information AgriRisk gives me is clear and understandable.': 'Amakuru AgriRisk impa arasobanutse kandi arumvikana.',
    'Overall, I find AgriRisk easy to use.': 'Muri rusange, mbona AgriRisk yoroshye gukoresha.',
    'I am satisfied with the advice AgriRisk gives.': 'Nishimiye inama AgriRisk itanga.',
    'AgriRisk meets my needs for crop and market information.': "AgriRisk ihaza ibyo nkeneye mu makuru y'imyaka n'ay'isoko.",
    'I would recommend AgriRisk to other farmers or officers.': 'Nasaba abandi bahinzi cyangwa abajyanama gukoresha AgriRisk.',
    'Overall, I am satisfied with AgriRisk.': 'Muri rusange, nishimiye AgriRisk.',
    'I feel confident giving advice based on data.': 'Numva mfite icyizere cyo gutanga inama zishingiye ku makuru.',
    'Which stage?': 'Ni ikihe cyiciro?',
    'Before using AgriRisk (baseline)': "Mbere yo gukoresha AgriRisk (urwego rw'ibanze)",
    'After using AgriRisk': 'Nyuma yo gukoresha AgriRisk',
    'Answer the baseline once before you start, then the full questionnaire after you have used the platform. Use the same participant code both times.':
        "Subiza ikibazo cy'ibanze rimwe mbere yo gutangira, hanyuma usubize ibibazo byose nyuma yo gukoresha urubuga. Koresha kode imwe inshuro zombi.",
    'Baseline: answer this one question before you start using AgriRisk.': "Urwego rw'ibanze: subiza iki kibazo kimwe mbere yo gutangira gukoresha AgriRisk.",
    'Baseline recorded. Come back after using AgriRisk to finish.': "Urwego rw'ibanze rwanditswe. Garuka nyuma yo gukoresha AgriRisk urangize.",
    'Your baseline': "Urwego rwawe rw'ibanze",
    'before use': 'mbere yo gukoresha',
    'Anonymous code given to you by the researcher. Use the same code every time you answer.':
        "Kode itazwi wahawe n'umushakashatsi. Koresha kode imwe buri gihe usubiza.",
    'A short questionnaire about how useful and easy to use AgriRisk is. Your answers are anonymous, we store only your participant code, never your name or phone.':
        'Ibibazo bigufi ku kamaro no ku buryo AgriRisk yoroshye gukoresha. Ibisubizo byawe ntibimenyekana, tubika gusa kode yawe, ntitwigera tubika izina cyangwa telefoni.',
    'Does AgriRisk help you do your work?': 'Ese AgriRisk igufasha gukora akazi kawe?',
    'Is AgriRisk easy to work with?': 'Ese AgriRisk yoroshye gukoresha?',
    'How do you feel about AgriRisk overall?': 'Wumva umeze ute kuri AgriRisk muri rusange?',
}
...
# ---- added translations (draft, to be reviewed by a native speaker) ----
RW.update({
    'Farmer Alerts': "Imiburo y'abahinzi",
    'Feedback': 'Ibitekerezo',
    'National average': "Impuzandengo y'igihugu",
    '1 year': 'Umwaka 1',
    '2 years': 'Imyaka 2',
    '3 years': 'Imyaka 3',
    'All': 'Byose',
    'History shown': 'Amateka agaragara',
    'Rwanda national average across all districts (median of market prices), expressed as a farmgate price; next-month trend from the model.': "Impuzandengo y'igihugu cy'u Rwanda ku turere twose (hagati y'ibiciro by'isoko), yerekanwe nk'igiciro ku murima; icyerekezo cy'ukwezi gutaha kiva mu moderi.",
    'Pick a crop and district to see the forecast.': "Hitamo igihingwa n'akarere kugira ngo urebe iteganya.",
    'Compare all districts (national view)': "Gereranya uturere twose (ireba ry'igihugu)",
    'No comparable price data for this crop yet.': "Nta makuru y'igiciro agereranywa kuri iki gihingwa arahari.",
    'Now (RWF/kg)': 'Ubu (RWF/kg)',
    'Change %': 'Impinduka %',
    'Risk across all districts (national view)': "Ibyago ku turere twose (ireba ry'igihugu)",
    'Risk': 'Ibyago',
    'This season, nationally: {hi} High, {md} Medium, {lo} Low. Food prices and fertilizer costs are national; rainfall differs by district.': "Muri iki gihembwe, mu gihugu: {hi} Biri hejuru, {md} Biri hagati, {lo} Biri hasi. Ibiciro by'ibiribwa n'iby'ifumbire ni iby'igihugu; imvura itandukanira ku karere.",
    'Forecast window': "Igihe cy'iteganya",
    '{n}-day': 'iminsi {n}',
    'Crop disease warnings for the next {n} days, based on the local weather forecast.': "Imiburo y'indwara z'ibihingwa mu minsi {n} iri imbere, ishingiye ku iteganyagihe ryo aho.",
    'This week (7 days)': 'Iki cyumweru (iminsi 7)',
    'Two weeks (14 days)': 'Ibyumweru bibiri (iminsi 14)',
    '{n}-day horizon': "igihe cy'iminsi {n}",
    'Wet {n} days ({mm}mm), leaves stay wet, which lets fungal spores spread.': "Iminsi {n} y'imvura ({mm}mm), amababi aguma atose, bituma fungus ikwira.",
    'No elevated disease risk in the next {n} days, the steps below are preventive.': "Nta byago byinshi by'indwara mu minsi {n} iri imbere; intambwe zikurikira ni izo kwirinda.",
    'Live {n}-day weather forecast.': "Iteganyagihe nzima ry'iminsi {n}.",
    '{n}-day rainfall': "Imvura y'iminsi {n}",
    'next {n} days': 'iminsi {n} iri imbere',
    'Phone number ': 'Nimero ya telefoni ',
    'District ': 'Akarere ',
    'Send text to this number': 'Ohereza ubutumwa kuri iyi nimero',
    'This page is for extension officers and administrators.': "Uru rupapuro ni urw'abajyanama b'ubuhinzi n'abayobozi.",
    'Farmer SMS channel': "Umuyoboro wa SMS w'abahinzi",
    'Phone number': 'Nimero ya telefoni',
    'Crops': 'Ibihingwa',
    'Add subscriber': 'Ongeraho umwiyandikisha',
    'Remove a subscriber': 'Kuraho umwiyandikisha',
    'No subscribers yet. Enroll a farmer above, or they can text YEGO to opt in.': 'Nta biyandikishije baraho. Andika umuhinzi haruguru, cyangwa bashobora kwandika YEGO bakiyandikisha.',
    'This will send a real SMS to every subscriber and charge your account.': 'Ibi bizohereza SMS nyazo kuri buri wiyandikishije kandi bicibwe kuri konti yawe.',
    'Send weekly alerts': 'Ohereza imiburo ya buri cyumweru',
    'Send mode': 'Uburyo bwo kohereza',
    'Subscribers': 'Abiyandikishije',
    'Enroll a farmer': 'Andika umuhinzi',
    'Preview & send a text': 'Reba & ohereza ubutumwa',
    'Message preview': "Igaragaza ry'ubutumwa",
    'characters': 'inyuguti',
    'Send the weekly alert to all subscribers': 'Ohereza imiburo ya buri cyumweru ku biyandikishije bose',
    'Channel': 'Umuyoboro',
    "SMS via Africa's Talking (basic phones, no internet)": "SMS binyuze muri Africa's Talking (telefoni zisanzwe, nta internet)",
    'Opt-out': 'Guhagarika',
    'Farmers reply STOP any time.': 'Abahinzi bandika STOP igihe icyo ari cyo cyose.',
    'Enter a phone number and at least one crop.': "Andika nimero ya telefoni n'igihingwa nibura kimwe.",
    'Send weekly alerts to {n} subscribers': 'Ohereza imiburo ya buri cyumweru ku biyandikishije {n}',
    'That phone number is already subscribed.': 'Iyo nimero ya telefoni yamaze kwiyandikisha.',
    'Remove {phone}': 'Kuraho {phone}',
    'Send failed: {err}': 'Kohereza byanze: {err}',
    '{mode}: {ok}/{total} alerts processed.': '{mode}: imiburo {ok}/{total} yatunganyijwe.',
    '{n} failed (e.g. {err})': '{n} byanze (urugero {err})',
    'Added {phone} ({district}).': 'Byongeweho {phone} ({district}).',
    'LIVE — messages go to real phones and your account is charged.': 'NZIMA — ubutumwa bujya kuri telefoni nyazo kandi konti yawe iracibwa.',
    "Simulated — nothing is sent and nothing is charged. Set the Africa's Talking keys to send for real.": "Byigana — nta kintu koherezwa kandi nta kiguzwe. Shyiraho impfunguzo za Africa's Talking kugira ngo wohereze by'ukuri.",
    "Sandbox — messages appear in the Africa's Talking simulator, not on a real phone.": "Sandbox — ubutumwa bugaragara mu igerageza rya Africa's Talking, atari kuri telefoni nyazo.",
    'Sending…': 'Kohereza…',
...
# ---- consolidated advisory summary page ----
RW.update({
    'Land size (ha)': "Ubuso bw'ubutaka (ha)",
    'Generate advisory': 'Tegura inama',
    'Building advisory…': 'Gutegura inama…',
    'Consolidated advisory': "Incamake y'inama yuzuye",
    'SEASONAL RISK': "IBYAGO BY'IGIHEMBWE",
    'DISEASE (next 14 days)': 'INDWARA (iminsi 14 iri imbere)',
    'INPUT PLAN': "GAHUNDA Y'IFUMBIRE",
    'Advisory preview': "Igaragaza ry'inama",
    'Generated by the same engine as the chat, SMS and WhatsApp, so the figures match.': "Byakozwe na moteri imwe n'iy'ikiganiro, SMS na WhatsApp, ku buryo imibare ihuye.",
})

# ---- input catalogue admin page ----
RW.update({
    'Input name': "Izina ry'ikoresho",
    'Crops (comma-separated)': "Ibihingwa (bitandukanyijwe n'akitso)",
    'Save catalogue': 'Bika urutonde',
    'Saved. {n} items are now in the catalogue.': 'Byabitswe. Ibikoresho {n} biri mu rutonde ubu.',
    '{n} items currently in the catalogue.': 'Ibikoresho {n} biri mu rutonde.',
    'Input Catalogue': "Urutonde rw'Ibikoresho",
